...
export const bakong: ArticleContent = {
  slug: 'bakong',
  title: 'Bakong: Cambodia\'s Central Bank Digital Currency and Instant Payment System',
  ...
  faqs: [
    ...
    { question: 'Can foreign businesses integrate with Bakong?', answer: 'Yes. Foreign enterprises operating in Cambodia can integrate with Bakong through participant banks. CamFinTech provides technical architecture and API integration services for enterprises connecting to Bakong payment rails, including cross-border settlement capabilities.' },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      content: 'CamFinTech provides end-to-end Bakong integration services for enterprises. This includes API architecture design for Bakong Open API connectivity, KHQR merchant onboarding, payment gateway development, and reconciliation system implementation.\n\nCamFinTech\'s integration approach ensures enterprises can accept Bakong payments across online and offline channels while maintaining full compliance with NBC regulatory requirements.',
    },
  ],
};
