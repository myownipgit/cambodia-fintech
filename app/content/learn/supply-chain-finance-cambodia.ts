...
export const supplyChainFinanceCambodia: ArticleContent = {
  ...
  description: 'An in-depth guide to supply chain finance in Cambodia, covering CamInvoice verified data for invoice financing, trade finance gaps, SME credit access, National Single Window customs data, bank partnerships, and the SCF middleware approach.',
  type: 'learn',
  cluster: 'investment',
