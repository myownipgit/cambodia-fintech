...
export const howToAcceptKHQR: ArticleContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: 'KHQR transactions settle instantly on the Bakong ledger, and acquiring banks provide reconciliation data through their merchant portals and APIs. Each transaction record includes a unique Bakong transaction ID, timestamp, payer institution, amount, currency, and settlement status.\n\nFor businesses with multiple outlets or high transaction volumes, automated reconciliation is essential. CamFinTech builds reconciliation pipelines that match KHQR settlement records against the merchant\'s internal sales records, flagging discrepancies and generating daily reports. The Bakong transaction ID serves as the universal reference for dispute resolution. Most acquiring banks provide transaction data via CSV export, API query, or SFTP push on a daily basis.',
    },
    {
    ...
    },
    {
      ...
      content: 'KHQR\'s cross-border corridors with Thailand\'s PromptPay, Malaysia\'s DuitNow, and China\'s Alipay mean that tourists from these countries can pay at any KHQR merchant using their home country banking apps. The tourist scans the same KHQR code that domestic customers use. The Bakong system identifies the foreign payment source, routes it through the bilateral corridor, performs currency conversion, and settles in the merchant\'s local currency.\n\nFor tourism-dependent businesses in Siem Reap, Phnom Penh, and Sihanoukville, this capability eliminates the need for separate Alipay or WeChat Pay merchant registrations. A single KHQR code handles both domestic and tourist payments. CamFinTech advises hospitality and retail businesses on optimizing their KHQR setup for multi-corridor acceptance.',
    },
    {
      heading: 'Getting Started with CamFinTech',
      content: 'CamFinTech provides end-to-end KHQR integration services tailored to your business type and scale. For small merchants, we facilitate rapid registration through our banking partners and provide staff training on payment acceptance. For medium and large enterprises, we design custom integration architectures covering POS systems, e-commerce platforms, and back-office reconciliation.\n\nOur technical team handles API integration, webhook configuration, error handling, and testing against the Bakong sandbox environment. We also provide ongoing monitoring and support to ensure your KHQR acceptance runs smoothly as the NBC introduces new features and cross-border corridors. Whether you are a single-location restaurant or a multi-branch retail chain, CamFinTech ensures you capture the full value of Cambodia\'s QR payment revolution.',
    },
  ],
};
